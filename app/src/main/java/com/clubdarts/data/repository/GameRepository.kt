...
class GameRepository @Inject constructor(
    ...
    suspend fun getAllPlayerLegsWon(): Map<Long, Int> = legDao.getAllPlayerLegsWon().associate { it.playerId to it.value }
    ...
    suspend fun getAllPlayerWins(): Map<Long, Int> = gameDao.getAllPlayerWins().associate { it.playerId to it.value }
    suspend fun getAllPlayerGamesPlayed(): Map<Long, Int> = gameDao.getAllPlayerGamesPlayed().associate { it.playerId to it.value }
